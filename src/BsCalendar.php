 ...
 * BsCalendar.php
 * ------------------------
 * Contains BS year → [12 months + totalDays] array
 * Ownership: Jeeven Lamichhane
 */
...
class BsCalendar
{
    ...
    public static function nepaliMonthsInEng()
    {
        return [
            "Baisakh",
            "Jestha",
    ...
    public static function nepaliMonthsInNep()
    {
        return [
            "बैशाख",
            "जेठ",
    ...
    public static function nepaliWeekDays()
    {
        return [
            "आइतवार",
            "सोमवार",
    ...
    public static function nepaliDigits()
    {
        return [
            "०",
            "१",
    ...
    public static function getYear(int $year): ?array
    {
        return self::$data[$year] ?? null;
    }
}
